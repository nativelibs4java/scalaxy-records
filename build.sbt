...
libraryDependencies <+= version("com.nativelibs4java" %% "scalaxy-reified" % _)
...
pomExtra := (
  <scm>
    <url>git@github.com:nativelibs4java/scalaxy-records.git</url>
    <connection>scm:git:git@github.com:nativelibs4java/scalaxy-records.git</connection>
  </scm>
  <developers>
    <developer>
      <id>ochafik</id>
